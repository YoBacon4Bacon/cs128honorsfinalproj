    ...
    pub fn new(item_type:&str, order_number:i32) -> Item{
        Item{
            ...
            cooking_time:match item_type{
                "Hamburger"=>2000,
                "Cheeseburger"=>2000,
                "Double Hamburger"=>4000,
                "Double Cheeseburger"=>4000,
                "McDouble"=>4000,
                "Big Mac"=>4000,
                "Quarter Pounder"=>2500,
                "Quarter Pounder with Cheese"=>2500,
                "Double Quarter Pounder"=>5000,
                "Double Quarter Pounder with Cheese"=>5000,
                "Small Fry"=>3000,
                "Medium Fry"=>4000,
                "Large Fry"=>5000,
                "4 McNuggets"=>3000,
